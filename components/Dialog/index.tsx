  ...
  return (
    <Portal>
      <div className="fixed inset-0 flex items-center justify-center z-50">
        ...
        <div className="bg-white border  shadow-lg z-10 p-6 w-1/3 dark:bg-gray-900 dark:text-white dark:border-gray-800 dark:shadow-gray-100/10	slide-in" ref={modalRef}>
