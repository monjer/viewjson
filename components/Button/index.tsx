...
const Button: React.ForwardRefRenderFunction<HTMLButtonElement, ButtonProps> = (props: ButtonProps, ref: React.Ref<HTMLButtonElement>) => {
  ...
  const baseStyles = 'inline-flex items-center justify-center whitespace-nowrap rounded cursor-pointer border border-gray-300 text-xs transition-all ease-in-outrounded px-1 py-1 shrink-0 grow-0';
